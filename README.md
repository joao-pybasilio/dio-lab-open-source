...
4. Crie uma nova **branch** e nomeie como `feat/community/joao-pybasilio` `git checkout -b feat/community/joaopybasilio`;
    > Exemplo: `git checkout -b feat/community/joao-pybasilio`
